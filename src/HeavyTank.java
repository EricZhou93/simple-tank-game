...
public class HeavyTank extends Vehicle{
    ...
    public HeavyTank(
        ...
        // Set linear speed.
        this.speedX = 0.5 * Vehicle.unitWidth;
        this.speedY = 0.5 * Vehicle.unitLength;
    ...
    protected Shape getHullShape() {
        ...
        this.hullLength = Vehicle.unitLength * 3.5;
        // Set the hull center position.
        this.hullCenterPosX = this.centerPosX;
        this.hullCenterPosY = this.centerPosY + this.hullLength / 14;
    ...
    protected Shape getTurretShape(){
        ...
        this.turretCenterPosY = this.centerPosY + this.turretLength / 2;
    ...
    protected Shape getArtilleryShape(){
        ...
        this.artilleryWidth = Vehicle.unitWidth / 2;
        this.artilleryLength = Vehicle.unitLength * 2;
    ...
    protected Shape getLeftTrackShape(){
        ...
        this.trackLength = Vehicle.unitLength * 4;
